...
android {
    namespace = "com.mpierucci.android.oktastartupissue"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.mpierucci.android.oktastartupissue"
        minSdk = 28
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
        ...
        manifestPlaceholders["webAuthenticationRedirectScheme"] = "test.krakenfield.mobile"
    }
